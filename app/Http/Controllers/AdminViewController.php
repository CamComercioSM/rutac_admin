    ...
    public function dashboard(Request $request) {
        ...
        $data =
            [
                ...
                'diagnosticos' => UnidadProductiva::select('complete_diagnostic', DB::raw('count(1) as cantidad'))
                ...
                'etapas' => UnidadProductiva::select('t.etapa_id', 't.name as nombre', 't.image', DB::raw('COUNT(1) as cantidad'))
                ...
                'tiposRegistro' => UnidadProductiva::select('t.unidadtipo_id', 't.unidadtipo_nombre as nombre', DB::raw('COUNT(1) as cantidad'))
                ...
                'tiposOrganizacion' => UnidadProductiva::select('t.tipopersona_id', 't.tipoPersonaNOMBRE as nombre', DB::raw('COUNT(1) as cantidad'))
                ...
                'municipios' => UnidadProductiva::select('t.municipio_id', 't.municipioNOMBREOFICIAL as nombre', DB::raw('COUNT(1) as cantidad'))
                ...
                // Consultamos las novedades activas usando el Modelo de Soporte
