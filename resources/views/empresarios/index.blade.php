...
@section('form-fields')
    <div class="row">
        ...
        <div class="col-12 col-md-4 form-group mb-3">
            ...
            <input type="text" class="form-control" name="identification" id="identification" placeholder="N° documento" pattern="[A-Za-z0-9]+" required>
        ...
        <div class="col-12 col-md-6 form-group mb-3">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="Nombre (s)" maxlength="200" required>
        ...
        <div class="col-12 col-md-6 form-group mb-3">
            ...
            <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Apellido (s)" maxlength="200" required>
...
@section('script')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Validación de máximo 200 caracteres para campos de nombre y apellido
            const nombreFields = ['name', 'lastname'];
            ...
            if (documentoField) {
                // Prevenir entrada de caracteres no alfanuméricos (excepto espacios que se eliminan)
                documentoField.addEventListener('keypress', function(e) {
                    const char = String.fromCharCode(e.which);
                    // Permitir letras, números, y convertir a mayúsculas automáticamente
