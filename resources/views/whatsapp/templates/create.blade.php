            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h3 mb-1 text-dark fw-bold">
                        <i class="icon-base ri ri-add-line text-primary me-2"></i>
                        Nueva plantilla WhatsApp
                    </h2>
                    <p class="text-muted mb-0">Crear plantilla para envío de mensajes</p>
                </div>
                    ...
                    <form action="{{ route('admin.whatsapp.templates.store') }}" method="POST" id="templateForm">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('category_id') is-invalid @enderror" id="category_id" name="category_id" required>
                                    ...
                                    @foreach($categories as $c)
                                        <option value="{{ $c->id }}" {{ old('category_id', request('category_id')) == $c->id ? 'selected' : '' }}>{{ $c->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('group_code') is-invalid @enderror" id="group_code" name="group_code" value="{{ old('group_code') }}" maxlength="100">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('channel') is-invalid @enderror" id="channel" name="channel" value="{{ old('channel', 'whatsapp') }}" maxlength="50">
                            ...
                            <input type="hidden" name="default_payload" value="{}">
                            <div class="col-12 mb-3">
                                ...
                                <div id="expectedFieldsContainer" class="mb-2">
                                    <div class="expected-field-row row g-2 mb-2 align-items-center">
                                        <div class="col-md-5"><input type="text" class="form-control key-input" placeholder="Clave (ej: usuarioNOMBRE)" /></div>
                                        <div class="col-auto"><label class="form-check-label me-2"><input type="checkbox" class="form-check-input required-input" /> Requerido</label></div>
                                ...
                                <input type="hidden" name="expected_fields" id="expected_fields" value="{{ old('expected_fields', '[]') }}" />
