...
@section('page-script')
    @vite('resources/js/reporteMensual/reporteMensual.js')
@endsection
...
@section('content')
    ...
    <div class="card bg-transparent shadow-none border-0 mb-6">
        <div class="card-body row g-6 p-0 pb-4">
            <div class="col-12 col-md-8 card-separator">
                <h5 class="mb-2">Bienvenid@<span class="h4 fw-semibold"> {{ auth()->user()->name }}</span></h5>
                <div class="col-12 col-lg-7">
                    <p>Aqui podras visualizar los informes mensuales de los gestores</p>
                </div>
    ...
    <div class="card mb-4">
        <div class="card-header border-bottom">
            ...
            <div class="row pt-4 pb-2 gx-5 gy-3">
                <div class="col-md-4 reporte_estado"></div>
                <div class="col-md-4 reporte_periodo"></div>
                <div class="col-md-4 reporte_gestor"></div>
            </div>
